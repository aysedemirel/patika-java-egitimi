package org.ayse.java101.login;
...
public class Login {
  ...
  public void changePassword(String oldPassword){
    ...
    while(!isPasswordChanged){
      ...
      {
        System.out.println("The new password cannot be the same as the old password or the last entered password. Please enter a new one:");
      }
      else{
